...
export default function App() {
  ...
  return (
    <div className="cc-stage" data-palette={CONFIG.palette} style={{ position: 'relative' }}>
      ...
      <div className="cc-frame">
        <div className="cc-portal">
          <AnimatePresence mode="wait">
            ...
            >
              {view === 'write' ? (
                <WriteScreen text={text} setText={setText} onContinue={release} />
              ) : (
                <ReleaseScreen text={text} style={CONFIG.releaseStyle} onRestart={restart} />
              )}
            </motion.div>
          </AnimatePresence>
        </div>
