...
export function WriteScreen({ text, setText, onContinue }: WriteScreenProps) {
  ...
  return (
    <div style={shell}>
      ...
      />
      {/* Scroll container (separate from the fixed night scene): on short or
          landscape phones the content can exceed the viewport — let it scroll
          instead of clipping the “Let it go” button off the bottom. */}
      <div
        style={{
          position: "absolute",
          inset: 0,
      ...
      >
        ...
        >
          <div
            style={{
              flex: "0 0 auto",
              padding: "clamp(48px, 13vh, 150px) 30px 0",
              textAlign: "center",
            }}
          >
            <h1
